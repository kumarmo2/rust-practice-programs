pub(crate) mod accesslog {
    pub(crate) mod v3 {
        ...
        pub struct TlsProperties {
            ...
            #[prost(message, optional, tag = "4")]
            pub local_certificate_properties:
                ::core::option::Option<tls_properties::CertificateProperties>,
            /// Properties of the peer certificate used to negotiate TLS.
            #[prost(message, optional, tag = "5")]
            pub peer_certificate_properties:
                ::core::option::Option<tls_properties::CertificateProperties>,
            /// The TLS session ID.
            #[prost(string, tag = "6")]
        ...
        pub mod tls_properties {
            ...
            pub struct CertificateProperties {
                ...
                pub subject_alt_name:
                    ::prost::alloc::vec::Vec<certificate_properties::SubjectAltName>,
